...
import 'package:chang05/Login/Login.dart';
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            Container(
              height: 150,
              child: HeaderRegister(150, false, Icons.person_add_alt_1_rounded),
            ),
            Container(
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            decoration: ThemeHelper()
                                .textInputDecoration('User', 'Enter your User'),
                          ),
